...
class heap:
	...
	def heapifyNew(self,i):
		...
		if(smallest!=i):
			...
			self.arr[i]=self.arr[smallest]
			self.arr[smallest]=temp
			tempArrayIndex=self.arrayIndex[i]
			self.arrayIndex[i]=self.arrayIndex[smallest]
			self.arrayIndex[smallest]=tempArrayIndex
			self.heapifyNew(smallest)
	...
	def extractMin(self,arrayIndex):
		...
		#print("here")
		#print(self.arr,self.currSize)
		self.arrayIndex[0]=self.arrayIndex[currSize-1]
		self.arrayIndex[currSize-1]=-1
		root=self.arr[0]
